...
import { useCreateWorkspaceFolder } from '../../api/use-create-workspace-folder';
import { useWorkspaceId } from '@/hooks/useWorkspaceId';

export const CreateWorkspaceFolder = () => {
  const { isOpen, close } = useFolderModalController();
  const { mutateAsync } = useCreateWorkspaceFolder();
